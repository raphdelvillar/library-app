      ...
      <v-flex xs12 sm7 offset-sm1>
        <v-card class="lcard" height="450px">
          <v-toolbar class="indigo">
            <v-btn icon v-bind:to="'/'" class="white">
          ...
          <div class="pa-2">
            <v-stepper v-model="e1" class="white">
              ...
              <v-stepper-content step="3" fluid style="overflow-y:scroll; height:250px">
                ...
                >
                  You have been successfully registered! You'll be redirected to login page after 3 seconds.
                </v-alert>
                <v-alert
                  icon="warning"
                  v-if="alert === 'failure'"
                ...
                >
                  Sorry! We have encountered an error. Try again later. You'll be redirected to login page after 3 seconds.
                </v-alert>
                <div v-if="alert === ''">
